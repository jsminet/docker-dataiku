# Let's play with 👋
# <p align="center">Daitaiku DSS</p>
  
This repository aims to install **a ready to use** Daitaiku environment using docker compose
    
## 🧐 Features    
- Daitaiku DSS free (some features are disabled without licence key)
- Oracle connection is not available with free edition, you can activate it using a docker compose profile
